...
Print Provisioning Package
    ...
    ${result} =     Run Process     python.exe  ${DFCI_PY_PATH}${/}GenerateCertProvisionData.py  -p  ${binfile}  shell=Yes   timeout=10sec    stdout=${stdoutfile}
    Log File    ${stdoutfile}
    Should Be Equal As Integers     ${result.rc}    0

Print Permission Package
    [Arguments]     ${binfile}  ${stdoutfile}
    ${result} =     Run Process     python.exe  ${DFCI_PY_PATH}${/}GeneratePermissionPacketData.py  -p  ${binfile}  shell=Yes   timeout=10sec    stdout=${stdoutfile}
    Log File    ${stdoutfile}
    Should Be Equal As Integers     ${result.rc}    0

Print Settings Package
    [Arguments]     ${binfile}  ${stdoutfile}
    ${result} =     Run Process     python.exe  ${DFCI_PY_PATH}${/}GenerateSettingsPacketData.py    -p  ${binfile}  shell=Yes   timeout=10sec    stdout=${stdoutfile}
    Log File    ${stdoutfile}
    Should Be Equal As Integers     ${result.rc}    0
...
Get Provisioning Result Package
    ...
    ${result} =     Run Process     python.exe  ${DFCI_PY_PATH}${/}GetSEMResultData.py  --Provisioning  --IpAddress ${IP_OF_DUT}    shell=Yes   timeout=10sec    stdout=${stdoutfile}
    Log File    ${stdoutfile}
    Should Be Equal As Integers     ${result.rc}    0
...
Get Permission Result Package
    [Arguments]     ${stdoutfile}
    ${result} =     Run Process     python.exe  ${DFCI_PY_PATH}${/}GetSEMResultData.py  --Permissions   --IpAddress ${IP_OF_DUT}    shell=Yes   timeout=10sec    stdout=${stdoutfile}
    Log File    ${stdoutfile}
    Should Be Equal As Integers     ${result.rc}    0
...
Get Settings Result Package
    [Arguments]     ${stdoutfile}
    ${result} =     Run Process     python.exe  ${DFCI_PY_PATH}${/}GetSEMResultData.py  --Settings  --IpAddress ${IP_OF_DUT}    shell=Yes   timeout=10sec    stdout=${stdoutfile}
    Log File    ${stdoutfile}
    Should Be Equal As Integers     ${result.rc}    0
